...
export function getNonEmptyQuestions(questions: Question[]): Question[] {
    ...
    /*const finalQuestions = filledQuestions.filter(
        (question: Question): boolean =>
 ...
 */
export function helperCsv(question: Question): string {
...
export function toCSV(questions: Question[]): string {
    ...
    questions = questions.map(
        (question: Question): Question => (
            (csv += helperCsv(question)), { ...question }
        )
    );
    return csv.trim();
}
...
export function sameType(questions: Question[]): boolean {
    const wrongType = questions.filter(
        (question: Question): boolean => question.type === questions[0].type
    );
    return wrongType.length === questions.length;
}
...
export function helperEdit(
    ...
    if (targetOptionIndex === -1) {
        return { ...question, options: [...question.options, newest] };
    } else {
        const newOptions = [...question.options];
        newOptions.splice(targetOptionIndex, 1, newest);
        return {
            ...question,
            options: [...newOptions]
        };
...
export function editOption(
    ...
    const newQuestions = questions.map(
        (question: Question): Question =>
            question.id === targetId
                ? {
                      ...helperEdit(question, newOption, targetOptionIndex)
                  }
                : { ...question }
    );
    /*if (targetOptionIndex !== -1) {
 ...
 */
export function duplicateHelper(newId: number, question: Question) {
...
export function duplicateQuestionInArray(
    ...
    const newQuestions = questions.map(
        (question: Question): Question =>
            question.id === targetId
                ? ((count = questions.indexOf(question)),
                  (newQuestion = duplicateHelper(newId, question)),
                  { ...question })
                : { ...question }
    );
    /*
    ...
    ;*/
    newQuestions.splice(count + 1, 0, newQuestion);
    return newQuestions;
}
